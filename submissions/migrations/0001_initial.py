    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('problem_id', models.IntegerField()),
                ('language_type', models.CharField(choices=[('c', 'C'), ('cpp', 'C++'), ('java', 'Java'), ('python', 'Python'), ('javascript', 'JavaScript')], max_length=20)),
                ('source_code', models.TextField()),
                ('code_hash', models.CharField(blank=True, max_length=64, null=True)),
                ('status', models.CharField(choices=[('pending', 'Pending'), ('accepted', 'Accepted'), ('wrong_answer', 'Wrong Answer'), ('time_limit_exceeded', 'Time Limit Exceeded'), ('memory_limit_exceeded', 'Memory Limit Exceeded'), ('runtime_error', 'Runtime Error'), ('compilation_error', 'Compilation Error'), ('system_error', 'System Error')], default='pending', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('problem_id', models.IntegerField()),
                ('assignment_id', models.IntegerField(blank=True, null=True)),
                ('language_type', models.CharField(choices=[('c', 'C'), ('cpp', 'C++'), ('java', 'Java'), ('python', 'Python'), ('javascript', 'JavaScript')], max_length=15)),
                ('source_code', models.TextField()),
